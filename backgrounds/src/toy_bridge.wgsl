...
fn fs_main(
    ...
    return vec4<f32>(
        tan(tan(sin(((uv.y + 3.0 * 1.4) / (uv.x - 0.5) * 0.04) * (u.time + 101.1)))) * 0.03, 
        tan(tan(sin(((uv.y + 3.0 * 1.4) / (uv.x - 0.5) * 0.04) * (u.time + 101.0)))) * 0.03, 
        tan(tan(sin(((uv.y + 3.0 * 1.4) / (uv.x - 0.5) * 0.04) * (u.time + 103.0)))) * 0.03, 
        1.0
    );
