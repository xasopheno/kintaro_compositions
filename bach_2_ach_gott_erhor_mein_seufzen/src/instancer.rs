...
impl Instancer for MegInstancer {
    fn update_instance(&self, instance: &mut Instance, dt: f32) {
        ...
        instance.position.x +=
            150.0 * (2.0 - instance.life) * f32::signum(instance.position.x - 0.01);
        // instance.position.y += f32::sin(3.0 * (2.0 - instance.life));
        // instance.position.y += 50.0 * (2.0 - instance.life);
        // instance.position.y +=
        // 700.0 * (2.0 - instance.life) * f32::signum(instance.position.y);
