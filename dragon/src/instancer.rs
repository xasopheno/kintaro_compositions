...
impl Instancer for Instancer1 {
    fn update_instance(&self, instance: &mut Instance, dt: f32) {
        ...
        instance.position.x += f32::sin(instance.life * 7.0) * 8000.0 * (2.0 - instance.life);
        // * f32::signum(instance.position.x);
        // instance.position.x += rng.gen_range(-10.0..10.0);
        instance.position.y -= f32::sin(instance.life * 5.0) * -4000.0 * (2.0 - instance.life);
        // * f32::signum(instance.position.y);
        instance.position.y +=
            f32::cos(dt * 1500.0 * f32::sin(instance.position.z * 2.0) * f32::tan(instance.life));
